        ...
        <div className="bg-white rounded-lg shadow p-4">
          ...
          <div className="mt-6 space-y-3">
            <Button
              ...
              className="w-full bg-amber-500 text-white py-3 rounded-lg font-medium text-center  hover:bg-amber-600 transition-colors flex items-center justify-center"
            >
            ...
            <Link
              href="/products"
              className="w-full border border-gray-300 text-gray-700 py-3 rounded-lg font-medium text-center  hover:bg-gray-100 transition-colors flex items-center justify-center"
            >
