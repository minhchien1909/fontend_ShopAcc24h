...
function Contacts() {
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      ...
      enqueueSnackbar("Có lỗi xảy ra khi xóa liên hệ", { variant: "error" });
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleReadContact = async (contact: any) => {
    ...
    try {
      ...
      enqueueSnackbar("Có lỗi xảy ra khi đánh dấu đã đọc", {
        variant: "error",
      });
    } finally {
      setIsLoading(false);
  ...
  const handleDeleteHistory = async (id: number) => {
    ...
    try {
      ...
      enqueueSnackbar("Có lỗi xảy ra khi xóa lịch sử", { variant: "error" });
    } finally {
      setIsLoading(false);
    }
  };
